        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input 
              type="text" 
              id="searchDeletedBy" 
              v-model="searchCriteria.deletedBy"
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input 
              type="date" 
              id="filterDateFrom" 
              v-model="searchCriteria.dateFrom"
            />
          </div>
          <div class="form-group">
        ...
        <div class="result-card" v-for="user in searchResults" :key="user.id" @click="viewUserDetails(user)">
          ...
          <div class="card-details">
            ...
            <div class="detail-item">
              ...
              <span>{{ formatDate(user.deletedAt) }}</span>
            </div>
            <div class="detail-item">
    ...
    const performSearch = () => {
      ...
      setTimeout(() => {
        ...
        if (searchCriteria.id) {
          results = results.filter(user => 
            user.id.toLowerCase().includes(searchCriteria.id.toLowerCase())
          );
        }
        ...
        if (searchCriteria.reason) {
          results = results.filter(user => 
            user.deletionReason === searchCriteria.reason
          );
        }
        ...
        if (searchCriteria.dateFrom) {
          ...
          results = results.filter(user => 
            new Date(user.deletedAt) >= fromDate
          );
        }
        ...
        if (searchCriteria.dateTo) {
          ...
          results = results.filter(user => 
            new Date(user.deletedAt) <= toDate
          );
        }
