  ...
  <div class="ticket-list-container">
    ...
    <div v-else-if="viewMode === 'table'" class="table-view">
      <table class="tickets-table">
        ...
        <tbody>
          <tr v-for="ticket in tickets" :key="ticket.id" @click="selectTicket(ticket)" class="ticket-row" :class="{ 'selected': isTicketSelected(ticket.id) }">
            ...
            <td>{{ ticket.assignedTo ? ticket.assignedTo : 'Nicht zugewiesen' }}</td>
        ...
        <div class="card-body">
          ...
          <div class="card-details">
            ...
            <div class="detail-item">
              ...
              <span class="detail-value">{{ ticket.assignedTo ? ticket.assignedTo : 'Nicht zugewiesen' }}</span>
            </div>
          </div>
        </div>
