  ...
  <div class="application-search-container">
    ...
    <div class="search-results" v-if="hasSearched">
      ...
      <div v-else class="results-list">
        ...
        <div class="application-card" v-for="application in searchResults" :key="application.id" @click="viewApplicationDetails(application.id)">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const performSearch = async () => {
      if (searchQuery.value.trim() === '' && statusFilter.value === '' && dateFrom.value === '' && dateTo.value === '') {
        return;
      }
