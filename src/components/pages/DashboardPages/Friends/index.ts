// src/components/pages/DashboardPages/Friends/index.ts
export { default as FriendsStats } from './FriendsStats.vue';
export { default as FriendsTabs } from './FriendsTabs.vue';
