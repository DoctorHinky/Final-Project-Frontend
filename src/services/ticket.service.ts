...
const mockTickets: Ticket[] = [
  {
    ...
    title: "Login-Problem",
    description:
      'Ich kann mich seit heute Morgen nicht mehr einloggen. Bei jedem Versuch erscheint "Ungültige Anmeldedaten", obwohl ich mir sicher bin, dass mein Passwort korrekt ist.',
  ...
  },
  {
    ...
    description:
      'Beim Versuch, meinen neuen Artikel hochzuladen, erscheint eine Fehlermeldung: "Format nicht unterstützt".',
  ...
  },
  {
    ...
    description:
      "Ich interessiere mich für die Premium-Mitgliedschaft, finde aber keine Informationen zu den verfügbaren Zahlungsmethoden.",
